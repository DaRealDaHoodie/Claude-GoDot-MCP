...
- **[Rufaty/godot-mcp-enhanced](https://github.com/DaRealDaHoodie/Claude-GoDot-MCP)** (MIT licensed) — The solid foundation we built on.
...
[Rufaty/godot-mcp-enhanced](https://github.com/DaRealDaHoodie/Claude-GoDot-MCP) — Enhanced significantly with signal management, group operations, autoload management, batch operations, class property discovery, save_scene, rename/reorder nodes, and fixed critical bug where all runtime tools were unrouted.
